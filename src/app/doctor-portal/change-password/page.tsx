    ...
    <div className="container mx-auto max-w-2xl py-10">
      <div className="mb-6 space-y-2">
        ...
        <p className="text-muted-foreground">
          Update your password to secure your account and continue to the portal.
        </p>
      </div>
      ...
      <Alert className="mb-6 border-amber-500/50 bg-amber-50 text-amber-900">
        ...
        <AlertDescription>Complete this step to finish setting up your account.</AlertDescription>
      </Alert>
