    ...
    <div className="flex flex-col">
      ...
      <section>
        <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/hospitals" className="text-sm font-medium text-accent-foreground flex items-center gap-1">
      ...
      {/* Doctors Section */}
       <section>
        <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/search" className="text-sm font-medium text-accent-foreground flex items-center gap-1">
                See All <ArrowRight className="h-4 w-4" />
            </Link>
        </div>
        <Carousel opts={{ align: 'start', dragFree: true }} className="w-full">
