            ...
            <div className="flex justify-center items-center gap-6 pt-4">
              {quickActions.map(({ href, label, icon, color }) => {
                  ...
                  <Link href={href} key={label} className="flex flex-col items-center gap-2 group text-center p-2">
                      <div className={cn("flex h-16 w-16 items-center justify-center rounded-2xl shadow-md transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg border-2 border-primary/20 hover:border-primary/60", color)}>
