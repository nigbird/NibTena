...
export default function AddScheduleDrawer({ isOpen, setIsOpen, doctors, hospitalId, onScheduleSaved }: AddScheduleDrawerProps) {
  ...
  const [schedules, setSchedules] = useState<DaySchedule[]>(
     weekDays.map(day => ({ dayOfWeek: day, workingHours: [{startTime: '09:00', endTime: '17:00'}], breakHours: [{startTime: '12:30', endTime: '13:30'}] }))
  );
  ...
  useEffect(() => {
    if (isOpen) {
        ...
        setSelectedDoctorId('');
        setSchedules(weekDays.map(day => ({ dayOfWeek: day, workingHours: [{startTime: '09:00', endTime: '17:00'}], breakHours: [{startTime: '12:30', endTime: '13:30'}] })));
    }
  }, [isOpen]);
